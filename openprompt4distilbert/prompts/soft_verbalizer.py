...
import json
from os import stat
from transformers4token.file_utils import ModelOutput
...
import re
from openprompt4distilbert import Verbalizer
from typing import *
import torch
...
import copy
from transformers4token.modeling_outputs import CausalLMOutputWithCrossAttentions, Seq2SeqLMOutput, MaskedLMOutput

from transformers4token.models.t5 import  T5ForConditionalGeneration
