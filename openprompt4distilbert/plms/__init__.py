...
from transformers4token.modeling_utils import PreTrainedModel
...
from transformers4token import DistilBertConfig, DistilBertTokenizer, DistilBertForMaskedLM, BertConfig, BertTokenizer, BertModel, BertForMaskedLM, \
