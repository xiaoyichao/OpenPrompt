...
# support loading transformers4token datasets from https://huggingface.co/docs/datasets/
from .nli_dataset import PROCESSORS as NLI_PROCESSORS

from openprompt4distilbert.utils.logging import logger
from openprompt4distilbert.data_utils.huggingface_dataset import PROCESSORS as HF_PROCESSORS
